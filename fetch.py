#!/usr/bin/env python3
"""
Recupero codici sconto JD Sports da shopilo.it
Sursa: https://shopilo.it/negozi/jdsports.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/jdsports.it"
STORE_NAME = "JD Sports"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per JD Sports da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-jdsports)"
    }
    try:
